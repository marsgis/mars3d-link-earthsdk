...
(function () {
    ...
    function load() {
        ...
        var libsConfig = {
            ...
            //     libpath + "cesiumjs/plugins/navigation/mars3d-navigation.css",
            //     libpath + "cesiumjs/plugins/navigation/mars3d-navigation.js",

            //     libpath + "cesiumjs/XbsjEarth/XbsjEarth.js",  //earthSDK
            //     libpath + "cesiumjs/XbsjCesium/XbsjCesium.js",//earthSDK
            //     // libpath + "earthsdk/XbsjEarth/thirdParty/navigator/standalone/viewerCesiumNavigationMixin.js",
            // ],

            'mars3d': [//在线测试地址，正式项目用上面注释的 
                libpath + "cesiumjs/Cesium1.66/Widgets/widgets.css",//Cesium ,因为earthSDK当前版本基于1.66
                libpath + "cesiumjs/Cesium1.66/Cesium.js",
                libpath + "cesiumjs/plugins/compatible/version.js",
                libpath + "cesiumjs/mars3d/mars3d.css", //mars3d
                libpath + "cesiumjs/mars3d/mars3d.js",
                libpath + "cesiumjs/plugins/navigation/mars3d-navigation.css",
                ...
                "lib/cesiumjs/XbsjEarth/XbsjEarth.js",  //earthSDK,自行在其官网下载最新版本后，放入对应目录
                "lib/cesiumjs/XbsjCesium/XbsjCesium.js",
            ],
